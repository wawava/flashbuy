...
-(void)applyEffectCircleSilverBorder
{
    ...
    self.layer.borderColor = [FNcolor sharedInstance].silver.CGColor;
...
-(void)applyEffectDarkGrayBorder
{
    ...
    self.layer.borderColor = [FNcolor sharedInstance].silverDark.CGColor;
...
-(void)applyEffectRoundRectShadow
{
    ...
    self.layer.shadowColor = [FNcolor sharedInstance].darkGray.CGColor;
