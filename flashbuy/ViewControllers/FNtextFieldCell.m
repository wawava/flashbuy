...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.backgroundColor = [FNcolor sharedInstance].clear;
        
        _ivBg = [UIImageView new];
        [self.contentView addSubview:_ivBg];
        
        _seperatorView = [UIView new];
        _seperatorView.backgroundColor = [FNcolor sharedInstance].silver;
        ...
        _textField.font = [FNfontLibrary sharedInstance].fontNormal;
...
-(void)setStyle:(ETDCellStyle)aStyle {
    switch (aStyle) {
        case kTDCellStyleTop:
            _ivBg.image = [FNimageLibrary sharedInstance].cellGroupTop;
            _seperatorView.hidden = NO;
            break;
            
        case kTDCellStyleMiddle:
            _ivBg.image = [FNimageLibrary sharedInstance].cellGroupMiddle;
            _seperatorView.hidden = NO;
            break;
            
        case kTDCellStyleBottom:
            _ivBg.image = [FNimageLibrary sharedInstance].cellGroupBottom;
            _seperatorView.hidden = YES;
            break;
            
        case kTDCellStyleRound:
            _ivBg.image = [FNimageLibrary sharedInstance].cellGroupRound;
            _seperatorView.hidden = YES;
            break;
