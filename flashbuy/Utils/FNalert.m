...
@implementation FNalert
DEF_SINGLETON(FNalert)
...
{
    FNdataAlertView *alertView = [[FNdataAlertView alloc] init];
    alertView.title = @"提示";
...
- (FNdataAlertView *)alert:(NSString *)aMessage delegate:(id/*<UIAlertViewDelegate>*/)aDelegate
{
...
{
    FNdataAlertView *alert = [[FNdataAlertView alloc] initWithTitle:aTitle
                                                    message:aMessage
                                                   delegate:aDelegate
...
- (void)alertView:(FNdataAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
