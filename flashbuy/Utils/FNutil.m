...
+(UIButton *)checkBoxWithTitle:(NSString *)aTitle target:(id)aTarget action:(SEL)anAction {
    ...
    [btn setImage:[FNimageLibrary sharedInstance].boxUnchecked forState:UIControlStateNormal];
    [btn setImage:[FNimageLibrary sharedInstance].boxChecked forState:UIControlStateSelected];
    [btn addTarget:aTarget action:anAction forControlEvents:UIControlEventTouchUpInside];
    btn.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    btn.titleEdgeInsets = UIEdgeInsetsMake(0, 5, 0, 0);
    btn.titleLabel.font = [FNfontLibrary sharedInstance].fontNormal;
    [btn setTitleColor:[FNcolor sharedInstance].black forState:UIControlStateNormal];
