...
+ (NSDictionary*)defaultOptions
{
	...
	return @{
			 ...
			 AMOptionsBackground : UIColorFromRGB(0x65686f),
			 AMOptionsSelectionBackground : UIColorFromRGB(0x4c4d51),
...
+ (NSDictionary*)defaultFlatOptions
{
	...
	return @{
			 ...
			 AMOptionsCellBackground : UIColorFromRGB(0x65686f),
			 ...
			 AMOptionsImageHeight : @(30),
			 AMOptionsImageOffsetByY : @(8),
			 AMOptionsDisableMenuScroll: @NO,
			 AMOptionsAnimationShrink : @YES,
			 AMOptionsAnimationShrinkValue : @0.3,
			 AMOptionsAnimationDarken : @YES,
