...
#define kViewGutter 0
#define kCheckInText @"开启购物"
#define kCheckOutText @"秒购! 秒购～"
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundImageView = [[UIImageView alloc] initWithFrame:CGRectMake(kViewGutter, 0, 320, 55)];
        ...
        self.checkInLabel.textColor = [UIColor whiteColor];
