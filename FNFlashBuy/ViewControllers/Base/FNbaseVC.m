...
{
    [super viewDidLoad];
    self.view.backgroundColor = [FNcolor sharedInstance].silver;
...
-(void)installLogoToNavibar {
    UIImage *logoImg = [FNimageLibrary sharedInstance].logoName;
...
-(void)installBackArrowToNavibar {
    UIImage *backImg = [FNimageLibrary sharedInstance].btnBackArrow;
